...
namespace Rokys.Audit.WebAPI.Controllers
{
    ...
    public class PeriodAuditFieldValuesController : ControllerBase
    {
        ...
        public PeriodAuditFieldValuesController(IPeriodAuditFieldValuesService service)
        {
            _service = service;
        }

        [HttpPost]
        public async Task<IActionResult> Create([FromBody] PeriodAuditFieldValuesRequestDto requestDto)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update([FromRoute] Guid id, [FromBody] PeriodAuditFieldValuesRequestDto requestDto)
        {
