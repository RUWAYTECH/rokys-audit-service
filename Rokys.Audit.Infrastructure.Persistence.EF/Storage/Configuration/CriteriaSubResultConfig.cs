    ...
    public class CriteriaSubResultConfig : IEntityTypeConfiguration<CriteriaSubResult>
    {
        public void Configure(EntityTypeBuilder<CriteriaSubResult> builder)
        {
            ...
            builder.HasIndex(x => x.ScaleGroupId)
                .HasDatabaseName("IX_CriteriaSubResult_ScaleGroupId");

            builder.HasIndex(x => x.AuditTemplateFieldId)
                .HasDatabaseName("IX_CriteriaSubResult_AuditTemplateFieldId");

            builder.HasIndex(x => x.CriteriaCode)
                .HasDatabaseName("IX_CriteriaSubResult_CriteriaCode");
        }
    }
}