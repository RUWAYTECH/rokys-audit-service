...
namespace Rokys.Audit.Subscription.Hub.Services.Interfaces
{
    ...
    public interface IEmployeeEventService
    {
        ...
        /// </summary>
        Task HandleEmployeeUpdatedAsync(EmployeeUpdatedEvent employeeEvent, CancellationToken cancellationToken = default);

        /// <summary>
        /// Procesa evento de eliminación de empleado
        /// </summary>
        Task HandleEmployeeDeletedAsync(EmployeeDeletedEvent employeeEvent, CancellationToken cancellationToken = default);
